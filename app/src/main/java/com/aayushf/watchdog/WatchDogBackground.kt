        ...
        logs_ref.addChildEventListener(object : ChildEventListener{
            ...
            override fun onChildAdded(p0: DataSnapshot, p1: String?) {
                var builder = NotificationCompat.Builder(this@WatchDogBackground, "99")
                    ...
                    .setContentText("Pliss Check")
                    .setPriority(NotificationCompat.PRIORITY_DEFAULT)
                    .addAction(R.drawable.outline_notification_important_white_48, "See pics", PendingIntent.getActivity(this@WatchDogBackground, 0, Intent(this@WatchDogBackground, HomeActivity::class.java), 0))
